...
```
Error: locator.check: Error: strict mode violation: getByRole('radio', { name: 'Mr' }) resolved to 2 elements:
...
- generic [active] [ref=f14e1]:
  ...
  - contentinfo [ref=f14e122]:
    - generic [ref=f14e127]:
      - heading "Subscription" [level=2] [ref=f14e128]
      - generic [ref=f14e129]:
        - textbox "Your email address" [ref=f14e130]
        - button "" [ref=f14e131] [cursor=pointer]
        - paragraph [ref=f14e133]: Get the most recent updates from our site and be updated your self...
    - paragraph [ref=f14e137]: Copyright © 2021 All rights reserved
  - text: 
```
