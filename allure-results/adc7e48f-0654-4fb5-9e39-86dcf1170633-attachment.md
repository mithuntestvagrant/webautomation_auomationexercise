...
- Location: tests/14_placeOrder.spec.ts:10:5
...
Call log:
  - waiting for locator('h2').filter({ hasText: 'Address Details' }) to be visible
...
- generic [active] [ref=f22e1]:
  ...
  - insertion [ref=f22e124]:
    - generic [ref=f22e127]:
      ...
      - link "Commercial Shopping Carts" [ref=f22e130] [cursor=pointer]
      - link "Dictionaries & Encyclopedias" [ref=f22e135] [cursor=pointer]
      - link "Industrial & Product Design" [ref=f22e140] [cursor=pointer]
```
