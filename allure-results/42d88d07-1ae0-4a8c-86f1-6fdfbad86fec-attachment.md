...
```
Error: locator.click: Error: strict mode violation: locator('a[href="/test_cases"]').filter({ hasText: 'Test Cases' }) resolved to 4 elements:
    1) <a href="/test_cases">…</a> aka getByRole('link', { name: ' Test Cases' })
    2) <a href="/test_cases" class="test_cases_list">…</a> aka getByRole('link', { name: 'Test Cases', exact: true })
    3) <a href="/test_cases" class="test_cases_list">…</a> aka locator('a').filter({ hasText: 'Test Cases' }).nth(2)
    4) <a href="/test_cases" class="test_cases_list">…</a> aka locator('a').filter({ hasText: 'Test Cases' }).nth(3)

Call log:
  - waiting for locator('a[href="/test_cases"]').filter({ hasText: 'Test Cases' })
    ...
    - generic [ref=e69]:
      ...
      - insertion [ref=e91]:
        - generic [ref=e94]:
          ...
          - link "Software testing webinars" [ref=e102] [cursor=pointer]
          - link "Automation engineer hiring" [ref=e107] [cursor=pointer]
          - link "API testing platforms" [ref=e112] [cursor=pointer]
          - link "Quality assurance software" [ref=e117] [cursor=pointer]
          - link "API development services" [ref=e122] [cursor=pointer]
          - link "Test automation tools" [ref=e127] [cursor=pointer]
          - link "Apparel" [ref=e132] [cursor=pointer]
      - generic [ref=e137]:
          ...
          - generic [ref=e328]:
            - generic [ref=e329]:
              ...
              - paragraph [ref=e332]:
                ...
                - link "Website hosting services" [ref=e333] [cursor=pointer]
          ...
          - generic [ref=e389]:
            - generic [ref=e390]:
              ...
              - paragraph [ref=e393]:
                ...
                - link "Quality assurance training" [ref=e394] [cursor=pointer]
          ...
          - generic [ref=e549]:
            - generic [ref=e550]:
              ...
              - paragraph [ref=e553]:
                ...
                - link "Software testing courses" [ref=e554] [cursor=pointer]
