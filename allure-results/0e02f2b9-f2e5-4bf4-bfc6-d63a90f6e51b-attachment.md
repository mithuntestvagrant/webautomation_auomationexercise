...
Call log:
  - waiting for locator('form').filter({ hasText: 'New User Signup!' }).getByPlaceholder('Email Address')
...
- generic [ref=f11e1]:
  ...
  - text: 
  - insertion [ref=f11e73]:
    - generic [ref=f11e76]:
      - heading "These are topics related to the article that might interest you" [level=2] [ref=f11e78]: Discover more
      - link "Software testing services" [ref=f11e79] [cursor=pointer]
      - link "Software testing tutorials" [ref=f11e84] [cursor=pointer]
      - link "Networking" [ref=f11e89] [cursor=pointer]
```
...
```ts
  ...
  18 | const email = page.locator('form', { hasText: 'New User Signup!' }).getByPlaceholder('Email Address');
